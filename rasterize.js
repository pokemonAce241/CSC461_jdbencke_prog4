     ...
     requestAnimationFrame(animate); 
        ...
        attackMissle1.rotation.y += 0.1;
         attackMissle1.position.y -= 0.01;
            if(attackMissle1.position.y < -2.5){
               attack1Status = 0.0;
                scene.remove(city1);
               }
           }
        ...
        attackMissle2.rotation.y += 0.1;
         attackMissle2.position.y -= 0.02;
               if(attackMissle2.position.y < -2.5){
               attack2Status = 0.0;
                scene.remove(city2);
               }
        }
        ...
        attackMissle3.position.y -= 0.025;
            if(attackMissle3.position.y < -2.5){
               attack3Status = 0.0;
                scene.remove(city3);
               }
           }
        ...
        attackMissle4.position.y -= 0.012;
            if(attackMissle4.position.y < -2.5){
               attack4Status = 0.0;
                scene.remove(city4);
               }
        }
        ...
        attackMissle5.position.y -= 0.03;
            if(attackMissle5.position.y < -2.5){
               attack5Status = 0.0;
                scene.remove(city5);
               }
           }
        ...
        attackMissle6.position.y -= 0.04;
               if(attackMissle6.position.y < -2.5){
               attack6Status = 0.0;
                scene.remove(city6);
               }
        }
